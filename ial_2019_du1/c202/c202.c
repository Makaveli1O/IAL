...
*/
	...
	/* 
		Pri prázdnom zásobníku vrátiť podľa zadania funkciu stackError()
		s hodnotou SEE_INIT ktorá odpovedá chybe pri stackInit

		Prázdny zásobník zodpovedá hodnote s->top = -1
	*/
	if (s == NULL){
...
*/
	/*
		Posledný prvok, podľa ktorého sa určí či je stack plný,
		je stack_size - 1 , pretože prvý prvok je na pozícií 0
	*/
...
*/
	...
	/*
		Ak vráti fukcia stackEmpty niečo iné ako 0 nastáva chyba
		inak vráti cez ukazateľ c čo sa nachádza na vrchu zásobníka.
	*/
...
*/
	...
	/*
		Ak funkcia stackEmpty vráči nenulovú hodnotu(zásobník je prázdny)
		ponecháme zásobník prázdny(zo zadania).
		Inak odstráni prvok z vrcholu zásobníka.
	*/
	if(stackEmpty(s) != 0){
		return;
	}else{
...
*/
	...
	/*
		Ak vráti funkcia stackFull nenulovú hodnotu zásobník je plný, a nastáva chyba.
		Inak pripočíta index ktorý ukazuje na vrchol zásobníku a pridá prvok "c"
	*/
	if(stackFull(s)!=0){
